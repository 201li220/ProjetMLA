...
class Fine_Tuning:
    ...
    def Tune(self):
        ...
        tokenized_datasets = tokenized_datasets.remove_colums(["idx", "sentence1", "sentence2"])
        tokenized_datasets = tokenized_datasets.remame_colums("label", "labels")
        ...
        metric_name = "pearson" if self.task == "stsb" else "matthews_correlation" if self.task == "cola" else "accuracy"
